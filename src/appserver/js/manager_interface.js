Ext.onReady(function(){
    ...
    var proxy = new Ext.data.HttpProxy({
       url:"interfaceManager.do?m=readInterface"
    });
...
//            	animEl:'ifUp.interface.info',
            	...
            	fn:function(e){
            		if(e == 'ok'){
            			Ext.Ajax.request({
            				url : 'interfaceManager.do?m=ifInterfaceUp',
...
//            	animEl:'ifUp.interface.info',
            	...
            	fn:function(e){
            		if(e == 'ok'){
            			Ext.Ajax.request({
            				url : 'interfaceManager.do?m=ifInterfaceDown',
            				params :{interfaceName : interfaceName},
            				success : function(action){
            					var json = Ext.decode(action.responseText);
            					Ext.MessageBox.show({
                            ...
                            fn:function(e){
                            	if(e=='ok'){
                            		formPanel.getForm().submit({
			                            url :'interfaceManager.do?m=saveInterface',
			                            method :'POST',
			                            waitTitle :'系统提示',
			                            waitMsg :'正在保存...',
...
function setName(interfaceName){
	...
	var name_store = new Ext.data.Store({
		id:'name_store.info',
	    url:"interfaceManager.do?m=readInterfaceName&t=interface",
	    reader:name_reader
	});
	name_store.load();
	var idx;
        ...
        Ext.each(selections,function(item){
        	...
        	Ext.MessageBox.show({
            	...
            	fn:function(e){
            		if(e == 'ok'){
            			Ext.Ajax.request({
            				url : 'interfaceManager.do?m=deleteInterface',             // 删除 连接 到后台
            				params :{interfaceName : interfaceName},
            				success : function(action){
            					var json = Ext.decode(action.responseText);
            					Ext.MessageBox.show({
                    ...
                    if (formPanel.form.isValid()) {
                        Ext.MessageBox.show({
                            ...
                            fn:function(e){
                            	if(e=='ok'){
                            		formPanel.getForm().submit({
			                            url :'interfaceManager.do?m=updateInterface',
			                            method :'POST',
			                            waitTitle :'系统提示',
			                            waitMsg :'正在保存...',
			                            success : function(form,action) {
                    ...
                    if (formPanel.form.isValid()) {
                        Ext.MessageBox.show({
                            ...
                            fn:function(e){
                            	if(e=='ok'){
                            		formPanel.getForm().submit({
			                            url :'interfaceManager.do?m=updateXNInterface',
			                            method :'POST',
			                            waitTitle :'系统提示',
			                            waitMsg :'正在保存...',
			                            success : function(form,action) {
                    ...
                    if (formPanel.form.isValid()) {
                        Ext.MessageBox.show({
                            ...
                            fn:function(e){
                            	if(e=='ok'){
                            		formPanel.getForm().submit({
			                            url :'interfaceManager.do?m=updateDNS',
			                            method :'POST',
			                            waitTitle :'系统提示',
			                            waitMsg :'正在保存...',
			                            success : function(form,action) {
