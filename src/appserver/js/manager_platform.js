Ext.onReady(function(){
    ...
    var systemRestartPanel = new Ext.Panel({
		id:'sysRestart.info',
		html:"<a href='javascript:;' onclick='systemRestart();' onmouseover='systemRestartMouseOver(event);' onmouseout='systemRestartMouseOut();' ><img src='../../img/icon/systemRestart.png' /></a>"
	});
	var equipmentRestartPanel = new Ext.Panel({
		id:'equiRestart.info',
		html:"<a href='javascript:;' onclick='equipmentRestart();' onmouseover='equipmentRestartMouseOver(event);' onmouseout='equipmentRestartMouseOut();'><img src='../../img/icon/equipmentRestart.png' /></a>"
	});
	var equipmentShutdownPanel = new Ext.Panel({
		id:'equiShutdown.info',
		html:"<a href='javascript:;' onclick='equipmentShutdown();' onmouseover='equipmentShutMouseOver(event);' onmouseout='equipmentShutMouseOut();'><img src='../../img/icon/equipmentShutdown.png' /></a>"
	});
	new Ext.Viewport({
