...
Ext.onReady(function(){
    ...
    var warProxy = new Ext.data.HttpProxy({
        url:"../../upgradeVersion.do?m=selectWar"
    });
    ...
    var jarProxy = new Ext.data.HttpProxy({
        url:"../../upgradeVersion.do?m=selectJar"
    });
    		...
    		handler:function(){
    			if (uploadWarForm.form.isValid()) {
                	uploadWarForm.getForm().submit({
		            	url :'../../upgradeVersion.do?m=uploadWar',
		                method :'POST',
		                waitTitle :'系统提示',
		                waitMsg :'正在上传...',
			                ...
			                Ext.MessageBox.show({
		                        ...
		                        fn:function(e){
		                        	if(e=='ok'){
                                        ...
                                        myMask.show();
                                        Ext.Ajax.request({
                                            url : '../../upgradeVersion.do?m=upgrade',
                                            method :'POST',
                                            waitTitle :'系统提示',
                                            waitMsg :'正在升级...',
...
function backVersion(){
    ...
    myMask.show();
    Ext.Ajax.request({
        url : '../../upgradeVersion.do?m=backup&warName='+warName,
        method :'POST',
        success : function(r,o) {
            myMask.hide();
            var respText = Ext.util.JSON.decode(r.responseText);
