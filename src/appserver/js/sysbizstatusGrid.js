		...
		items : ['上报日期晚于：', {
			...
			width : 10
                ...
                store : new Ext.data.JsonStore({
                    url : '../sysbizstatus.do?m=selsetByBisname',
                    root : 'rows',
//						idProperty : 'id',
                    fields : [ 'code', 'name' ]
                }),
                ...
                width : 100
					...
					listeners : {
						"click" : function() {
                            ...
                            var bisname = Ext.getCmp('bisname.info').getValue();
							store.setBaseParam("startDate", startDate);
							store.setBaseParam("endDate", endDate);
                            store.setBaseParam("bisname", bisname);
							store.load({
								params : {
									start : 0,
									limit : PAGESIZE
