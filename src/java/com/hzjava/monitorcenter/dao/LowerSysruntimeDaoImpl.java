...
import com.hzjava.monitorcenter.domain.LowerSysruntime;

public class LowerSysruntimeDaoImpl extends MyDaoSupport implements LowerSysruntimeDao {
	private final static Logger logger = Logger.getLogger(LowerSysruntimeDaoImpl.class);

	@Override
	public void setEntityClass() {
		this.entityClass = LowerSysruntime.class;
	}

	public PageResult findPage(int pageIndex, int pageLength, Date startDate,
			Date endDate, String idSystem) {
		StringBuffer sb = new StringBuffer(" from LowerSysruntime s where 1=1");
