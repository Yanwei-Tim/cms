...
import com.hzjava.monitorcenter.domain.LowerSysstatus;

public class LowerSysstatusDaoImpl extends MyDaoSupport implements LowerSysstatusDao {
	private final static Logger logger = Logger.getLogger(LowerSysstatusDaoImpl.class);

	@Override
	public void setEntityClass() {
		this.entityClass = LowerSysstatus.class;
	}

	public PageResult findPage(int pageIndex, int pageLength, Date startDate,
			Date endDate, String idSystem) {
		StringBuffer sb = new StringBuffer(" from LowerSysstatus s where 1=1");
