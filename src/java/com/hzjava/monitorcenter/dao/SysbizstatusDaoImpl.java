...
import com.hzjava.monitorcenter.domain.Sysbizstatus;

public class SysbizstatusDaoImpl extends MyDaoSupport implements SysbizstatusDao {
	private final static Logger logger = Logger.getLogger(SysbizstatusDaoImpl.class);

	@Override
	public void setEntityClass() {
		this.entityClass = Sysbizstatus.class;
	}

	public PageResult findPage(int pageIndex, int pageLength, Date startDate,
			Date endDate) {
		StringBuffer sb = new StringBuffer(" from Sysbizstatus s where 1=1");
