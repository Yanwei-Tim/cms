...
import com.hzjava.monitorcenter.domain.Sysstatus;

public class SysstatusDaoImpl extends MyDaoSupport implements SysstatusDao {
	private final static Logger logger = Logger.getLogger(SysstatusDaoImpl.class);

	@Override
	public void setEntityClass() {
		this.entityClass = Sysstatus.class;
	}

	public PageResult findPage(int pageIndex, int pageLength, Date startDate,
			Date endDate) {
		StringBuffer sb = new StringBuffer(" from Sysstatus s where 1=1");
