 ...
 *                scope="request" path="/lowerSysbizstatus" validate="false"
 *                parameter="m"
 * @struts.action-forward name="index"
 *                        path="/WEB-INF/pages/jlsb/lowerSysbizstatusJSON.jsp"
 */
public class LowerSysbizstatusAction extends DispatchActionSupport {
	private static Logger logger = Logger
			.getLogger(LowerSysbizstatusAction.class);
	...
	public ActionForward index(ActionMapping mapping, ActionForm form,
		...
		PageResult ps = jlsbService.listLowerSysbizstatusByPage(pageIndex,
