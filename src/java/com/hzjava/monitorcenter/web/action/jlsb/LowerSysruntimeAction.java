 ...
 *                scope="request" path="/lowerSysruntime" validate="false"
 *                parameter="m"
 * @struts.action-forward name="index"
 *                        path="/WEB-INF/pages/jlsb/lowerSysruntimeJSON.jsp"
 */
public class LowerSysruntimeAction extends DispatchActionSupport {
	private static Logger logger = Logger
			.getLogger(LowerSysruntimeAction.class);
	...
	public ActionForward index(ActionMapping mapping, ActionForm form,
		...
		PageResult ps = jlsbService.listLowerSysruntimeByPage(pageIndex,
