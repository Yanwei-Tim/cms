...
/**
 * 本级接入应用运行情况查询(sysbizstatus) 按业务下拉列表方式显示
 * @author xiangqi.java@gmail.com
 * @struts.action type="org.springframework.web.struts.DelegatingActionProxy"
 *                scope="request" path="/sysbizstatus" validate="false"
 *                parameter="m"
 * @struts.action-forward name="index"
 *                        path="/WEB-INF/pages/jlsb/sysbizstatusJSON.jsp"
 */
public class SysbizstatusAction extends DispatchActionSupport {
	private static Logger logger = Logger.getLogger(SysbizstatusAction.class);
	...
	public ActionForward index(ActionMapping mapping, ActionForm form,
		...
		PageResult ps = jlsbService.listSysbizstatusByPage(pageIndex, pageLength, startDate, endDate);
