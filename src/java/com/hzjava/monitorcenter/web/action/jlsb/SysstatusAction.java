...
/**
 * 本级系统运行情况查询(sysstatus)
 * @author xiangqi.java@gmail.com
 * @struts.action type="org.springframework.web.struts.DelegatingActionProxy"
 *                scope="request" path="/sysstatus" validate="false"
 *                parameter="m"
 * @struts.action-forward name="index"
 *                        path="/WEB-INF/pages/jlsb/sysstatusJSON.jsp"
 */
public class SysstatusAction extends DispatchActionSupport {
	private static Logger logger = Logger.getLogger(SysstatusAction.class);
	...
	public ActionForward index(ActionMapping mapping, ActionForm form,
		...
		PageResult ps = jlsbService.listSysstatusByPage(pageIndex, pageLength, startDate, endDate);
